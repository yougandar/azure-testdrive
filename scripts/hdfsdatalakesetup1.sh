...
echo "Your Datalake Endpoint for the testdrive: $datalakeEndPoint/$datalakeDirName" >> /home/cloudera/NodeDetails
echo "Your Output Data files on Datalake for the testdrive:  $datalakeEndPoint/$datalakeDirName/wordCount"
